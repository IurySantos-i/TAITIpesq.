...
tasks_file = 'tasks_allourideas.org.git.xlsx'
file_path = r'C:\Users\Marcos\Documents\Pesquisa TAITI\Dependências\allourideas\formalized_tasks_allourideas.org.git.xlsx'
...
for index, row in tasks.iterrows():
    ...
    repo = Repo('F:/Clones de reps. Taiti/allourideas.org.git')
...
tasks.to_excel(r'F:\Pesquisa TAITI\Dependências\allourideas\formalized_tasks_allourideas.org.git.xlsx')
