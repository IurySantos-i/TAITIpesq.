...
tasks_file = 'tasks_sequencescape.git.xlsx'
file_path = r'F:\Pesquisa TAITI\Dependências\sequencescape'
...
for index, row in tasks.iterrows():
    ...
    repo = Repo(r'F:\Pesquisa TAITI\Repositórios necessários\sequencescape.git')
...
tasks.to_excel(r'F:\Pesquisa TAITI\Dependências\sequencescape\formalized_tasks_sequencescape.git.xlsx')
