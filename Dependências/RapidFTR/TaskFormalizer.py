...
tasks_file = 'tasks_RapidFTR.git.xlsx'
file_path = r'F:\Pesquisa TAITI\Dependências\RapidFTR'
...
for index, row in tasks.iterrows():
    ...
    repo = Repo(r'F:\Pesquisa TAITI\Repositórios necessários\RapidFTR.git')
...
tasks.to_excel(r'F:\Pesquisa TAITI\Dependências\RapidFTR\formalized_tasks_RapidFTR.git.xlsx')
