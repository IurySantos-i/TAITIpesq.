...
tasks_file = 'tasks_opengovernment.git.xlsx'
file_path = r'F:\Pesquisa TAITI\Dependências\opengovernment'
...
for index, row in tasks.iterrows():
    ...
    repo = Repo(r'F:\Pesquisa TAITI\Repositórios necessários\opengovernment.git')
...
tasks.to_excel(r'F:\Pesquisa TAITI\Dependências\opengovernment\formalized_tasks_opengovernment.git.xlsx')
