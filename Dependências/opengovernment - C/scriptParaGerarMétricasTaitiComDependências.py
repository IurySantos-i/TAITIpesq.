...
path_of_the_directory = r"F:\Pesquisa TAITI\Dependências\opengovernment - F"
degreeofdependence= 30
df = pd.read_csv('https___github.com_opengovernment_opengovernment.csv',engine="python", sep=';')
...
df.to_excel('TaitiWithdeps_opengovernment.xlsx', index=False)
