...
token = "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"
headers = {
    "Accept": "application/vnd.github.v3+json",
    "Authorization": f"token {token}"
}

tasksDoProjeto = pd.read_excel('formalized_tasks_allourideas.org.git.xlsx')
commits = tasksDoProjeto[['Oldest Commit','Most Recent Commit']]

arquivoTaiti = 'https___github.com_allourideas_allourideas.org.csv'
partes = arquivoTaiti.split("_")
donoDoRepositorio = partes[-2]
repositorio = "allourideas.org"

degrees = ['dencies.csv','(10%).csv']

path_of_the_directory = r"/home/iury/Documents/Trabalho/Repositórios_necessários/allourideas.org/Análise do projeto e tasks/"
...
for filename in sorted(os.listdir(path_of_the_directory), key = natural_keys):
    if filename.endswith(degrees[0]) and not filename.startswith("http") and (pd.read_csv(filename, sep=";")).values.tolist() == []:
            ...
            numberoftestifiles.append(tempnumberoftaitifiles)
