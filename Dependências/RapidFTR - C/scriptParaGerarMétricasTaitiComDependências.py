...
path_of_the_directory = r"F:\Pesquisa TAITI\Dependências\RapidFTR - F"
degreeofdependence= 30
df = pd.read_csv('https___github.com_rapidftr_RapidFTR.csv',engine="python", sep=';')
...
df.to_excel('TaitiWithdeps_RapidFTR.xlsx', index=False)
