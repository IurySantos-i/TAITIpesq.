...
tasks_file = 'tasks_Claim-for-Crown-Court-Defence.git.xlsx'
file_path = r'F:\Pesquisa TAITI\Dependências\Claim-for-Crown-Court-Defence'
...
for index, row in tasks.iterrows():
    ...
    repo = Repo(r'F:\Pesquisa TAITI\Repositórios necessários\Claim-for-Crown-Court-Defence.git')
...
tasks.to_excel(r'F:\Pesquisa TAITI\Dependências\Claim-for-Crown-Court-Defence\formalized_tasks_Claim-for-Crown-Court-Defence.git.xlsx')
