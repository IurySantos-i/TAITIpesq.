...
df = pd.read_excel('formalized_tasks_Claim-for-Crown-Court-Defence.git.xlsx')

# set the path to the local git repository
repo_path = r'F:\Pesquisa TAITI\Repositórios necessários\Claim-for-Crown-Court-Defence.git'
