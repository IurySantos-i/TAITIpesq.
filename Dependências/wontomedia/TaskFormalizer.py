...
tasks_file = 'tasks_wontomedia.git.xlsx'
file_path = r'F:\Pesquisa TAITI\Dependências\wontomedia'
...
for index, row in tasks.iterrows():
    ...
    repo = Repo(r'F:\Pesquisa TAITI\Repositórios necessários\wontomedia.git')
...
tasks.to_excel(r'F:\Pesquisa TAITI\Dependências\wontomedia\formalized_tasks_wontomedia.git.xlsx')
