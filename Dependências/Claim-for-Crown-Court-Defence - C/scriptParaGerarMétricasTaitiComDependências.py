...
path_of_the_directory = r"F:\Pesquisa TAITI\Dependências\Claim-for-Crown-Court-Defence"
degreeofdependence= 30
df = pd.read_csv('https___github.com_ministryofjustice_Claim-for-Crown-Court-Defence.csv',engine="python", sep=';')
...
df.to_excel('TaitiWithdeps_Claim-for-Crown-Court-Defence.xlsx', index=False)
