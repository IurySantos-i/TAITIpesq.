...
tasks_file = 'tasks_action-center-platform.git.xlsx'
...
for index, row in tasks.iterrows():
    ...
    repo = Repo('F:/Clones de reps. Taiti/action-center-platform.git')
...
tasks.to_excel(r'C:\Users\Marcos\Documents\Pesquisa TAITI\Dependências\action-center-platform\formalized_tasks_action-center-platform.git.xlsx')
