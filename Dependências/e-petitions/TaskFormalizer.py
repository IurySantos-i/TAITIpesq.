...
tasks_file = 'tasks_e-petitions.git.xlsx'
file_path = r'F:\Pesquisa TAITI\Dependências\e-petitions'
...
for index, row in tasks.iterrows():
    ...
    repo = Repo(r'F:\Pesquisa TAITI\Repositórios necessários\e-petitions.git')
...
tasks.to_excel(r'F:\Pesquisa TAITI\Dependências\e-petitions\formalized_tasks_e-petitions.git.xlsx')
