...
path_of_the_directory = r"F:\Pesquisa TAITI\Dependências\quantified - F"
degreeofdependence= 30
df = pd.read_csv('https___github.com_sachac_quantified.csv',engine="python", sep=';')
...
df.to_excel('TaitiWithdeps_quantified.xlsx', index=False)
