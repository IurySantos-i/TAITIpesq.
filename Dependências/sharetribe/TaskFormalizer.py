...
tasks_file = 'tasks_sharetribe.git.xlsx'
file_path = r'F:\Pesquisa TAITI\Dependências\sharetribe'
...
for index, row in tasks.iterrows():
    ...
    repo = Repo(r'F:\Pesquisa TAITI\Repositórios necessários\sharetribe.git')
...
tasks.to_excel(r'F:\Pesquisa TAITI\Dependências\sharetribe\formalized_tasks_sharetribe.git.xlsx')
