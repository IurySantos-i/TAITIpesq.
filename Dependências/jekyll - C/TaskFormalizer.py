...
tasks_file = 'tasks_jekyll.git.xlsx'
file_path = r'F:\Pesquisa TAITI\Dependências\jekyll'
...
for index, row in tasks.iterrows():
    ...
    repo = Repo(r'F:\Pesquisa TAITI\Repositórios necessários\jekyll.git')
...
tasks.to_excel(r'F:\Pesquisa TAITI\Dependências\jekyll\formalized_tasks_jekyll.git.xlsx')
