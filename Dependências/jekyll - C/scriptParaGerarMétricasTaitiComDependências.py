...
path_of_the_directory = r"F:\Pesquisa TAITI\Dependências\jekyll"
degreeofdependence= 30
df = pd.read_csv('https___github.com_jekyll_jekyll.csv',engine="python", sep=';')
...
df.to_excel('TaitiWithdeps_jekyll.xlsx', index=False)
