...
tasks_file = 'tasks_gitlabhq.git.xlsx'
file_path = r'F:\Pesquisa TAITI\Dependências\gitlabhq'
...
for index, row in tasks.iterrows():
    ...
    repo = Repo(r'F:\Pesquisa TAITI\Repositórios necessários\gitlabhq.git\gitlabhq')
...
tasks.to_excel(r'F:\Pesquisa TAITI\Dependências\gitlabhq\formalized_tasks_gitlabhq.git.xlsx')
