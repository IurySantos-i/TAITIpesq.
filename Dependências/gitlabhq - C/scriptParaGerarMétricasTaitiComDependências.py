...
path_of_the_directory = r"F:\Pesquisa TAITI\Dependências\gitlabhq"
degreeofdependence= 30
df = pd.read_csv('https___github.com_gitlabhq_gitlabhq.csv',engine="python", sep=';')
...
df.to_excel('TaitiWithdeps_gitlabhq.xlsx', index=False)
