...
tasks_file = 'tasks_openproject.git.xlsx'
file_path = r'F:\Pesquisa TAITI\Dependências\openproject'
...
for index, row in tasks.iterrows():
    ...
    repo = Repo(r'F:\Pesquisa TAITI\Repositórios necessários\openproject.git')
...
tasks.to_excel(r'F:\Pesquisa TAITI\Dependências\openproject\formalized_tasks_openproject.git.xlsx')
