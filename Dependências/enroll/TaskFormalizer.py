...
tasks_file = 'tasks_enroll.git.xlsx'
file_path = r'F:\Pesquisa TAITI\Dependências\enroll'
...
for index, row in tasks.iterrows():
    ...
    repo = Repo(r'F:\Pesquisa TAITI\Repositórios necessários\enroll.git')
...
tasks.to_excel(r'F:\Pesquisa TAITI\Dependências\enroll\formalized_tasks_enroll.git.xlsx')
