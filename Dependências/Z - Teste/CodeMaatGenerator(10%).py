...
folder_path = "D:/Taiti Pesquisa/Dependências/Z - Teste"
...
for file in os.listdir(folder_path):
    if file.endswith("_raw_gitlog.log"):
        ...
        with open(output_file_path, "w") as output_file: # run Code Maat tool on the input file and save output to output file
            subprocess.run(f'java -jar code-maat-1.0.4-standalone.jar -l {file} -c git2 -a coupling  -i 10', stdout=output_file)
