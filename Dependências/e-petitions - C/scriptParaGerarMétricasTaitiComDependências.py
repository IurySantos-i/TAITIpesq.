...
path_of_the_directory = r"F:\Pesquisa TAITI\Dependências\e-petitions"
degreeofdependence= 30
df = pd.read_csv('https___github.com_alphagov_e-petitions.csv',engine="python", sep=';')
...
df.to_excel('TaitiWithdeps_e-petitions.xlsx', index=False)
