...
path_of_the_directory = r"F:\Pesquisa TAITI\Dependências\enroll"
degreeofdependence= 30
df = pd.read_csv('https___github.com_dchbx_enroll.csv',engine="python", sep=';')
...
df.to_excel('TaitiWithdeps_enroll.xlsx', index=False)
