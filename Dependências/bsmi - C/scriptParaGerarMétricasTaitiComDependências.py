...
path_of_the_directory = r"F:\Pesquisa TAITI\Dependências\bsmi - C"
degreeofdependence= 30
df = pd.read_csv('https___github.com_BTHUNTERCN_bsmi.csv',engine="python", sep=';')
...
df.to_excel('TaitiWithdeps_bsmi.xlsx', index=False)
