...
path_of_the_directory = r"F:\Pesquisa TAITI\Dependências\wontomedia - F"
degreeofdependence= 30
df = pd.read_csv('https___github.com_gleneivey_wontomedia.csv',engine="python", sep=';')
...
df.to_excel('TaitiWithdeps_wontomedia.xlsx', index=False)
