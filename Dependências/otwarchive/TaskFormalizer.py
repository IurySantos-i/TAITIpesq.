...
tasks_file = 'tasks_otwarchive.git.xlsx'
file_path = r'F:\Pesquisa TAITI\Dependências\otwarchive'
...
for index, row in tasks.iterrows():
    ...
    repo = Repo(r'F:\Pesquisa TAITI\Repositórios necessários\otwarchive.git')
...
tasks.to_excel(r'F:\Pesquisa TAITI\Dependências\otwarchive\formalized_tasks_otwarchive.git.xlsx')
