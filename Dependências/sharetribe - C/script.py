...
path_of_the_directory = r"F:\Pesquisa TAITI\Dependências\action-center-platform\Taiti com dependências"
...
for filename in os.listdir(path_of_the_directory):
    ...
    if filename.endswith('.csv') and not filename.startswith("http"):
        ...
        print(len(Taiti))
        print(len(Changed))
        print(len(intersection(Taiti,Changed)))
...
df.to_excel('finalaction center.xlsx', index=False)
