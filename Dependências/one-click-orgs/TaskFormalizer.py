...
tasks_file = 'tasks_one-click-orgs.git.xlsx'
file_path = r'F:\Pesquisa TAITI\Dependências\one-click-orgs'
...
for index, row in tasks.iterrows():
    ...
    repo = Repo(r'F:\Pesquisa TAITI\Repositórios necessários\one-click-orgs.git')
...
tasks.to_excel(r'F:\Pesquisa TAITI\Dependências\one-click-orgs\formalized_tasks_one-click-orgs.git.xlsx')
