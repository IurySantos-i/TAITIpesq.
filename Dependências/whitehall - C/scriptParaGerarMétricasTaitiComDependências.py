...
path_of_the_directory = r"F:\Pesquisa TAITI\Dependências\whitehall - F"
degreeofdependence= 30
df = pd.read_csv('https___github.com_alphagov_whitehall.csv',engine="python", sep=';')
...
df.to_excel('TaitiWithdeps_whitehall.xlsx', index=False)
