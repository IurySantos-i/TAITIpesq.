...
# Load the Excel file
xl = pd.ExcelFile('formalized_tasks_action-center-platform.git.xlsx')

# Get the sheet with the tasks
tasks_sheet = xl.parse('Sheet1')

# Initialize the GitPython repository object
repo = git.Repo('/home/iury/Documents/Trabalho/Repositórios_necessários/action-center-platform/')
